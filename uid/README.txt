...
Showing top 10 nodes out of 52 (cum >= 149.99MB)
  ...
  315.56MB 26.10% 26.10%   315.56MB 26.10%  github.com/dgraph/posting.NewList
   87.51MB  7.24% 33.33%    87.51MB  7.24%  github.com/dgraph/uid.stringKey
      80MB  6.62% 39.95%   105.50MB  8.72%  github.com/dgraph/uid.(*lockManager).newOrExisting
   78.01MB  6.45% 46.40%    78.01MB  6.45%  github.com/dgraph/posting.Key
   ...
   74.50MB  6.16% 65.38%    74.50MB  6.16%  github.com/zond/gotomic.newRealEntryWithHashCode
      51MB  4.22% 69.60%    74.01MB  6.12%  github.com/dgraph/posting.(*List).merge
   48.50MB  4.01% 73.61%    48.50MB  4.01%  github.com/dgraph/loader.(*state).readLines
   43.50MB  3.60% 77.21%   149.99MB 12.40%  github.com/zond/gotomic.(*Hash).PutIfMissing
(pprof) list uid.stringKey
Total: 1.18GB
ROUTINE ======================== github.com/dgraph/uid.stringKey in /home/manishrjain/go/src/github.com/dgraph/uid/assigner.go
...
Showing top 10 nodes out of 48 (cum >= 45.01MB)
      flat  flat%   sum%        cum   cum%
  310.56MB 27.26% 27.26%   310.56MB 27.26%  github.com/dgraph/posting.NewList
   ...
   81.50MB  7.15% 49.38%      109MB  9.57%  github.com/dgraph/uid.(*lockManager).newOrExisting
   76.51MB  6.72% 56.09%    76.51MB  6.72%  github.com/dgraph/posting.Key
   72.50MB  6.36% 62.46%    72.50MB  6.36%  github.com/zond/gotomic.newRealEntryWithHashCode
   55.50MB  4.87% 67.33%    63.50MB  5.57%  github.com/dgraph/posting.(*List).merge
      50MB  4.39% 71.72%       50MB  4.39%  github.com/dgraph/loader.(*state).readLines
